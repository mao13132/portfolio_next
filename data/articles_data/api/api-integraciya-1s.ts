...
export const articleApiIntegraciya1S: Article = {
    ...
    title: "API-интеграция с 1С: обмен данными | DimaRazrab",
    metaDescription: "API-интеграция с 1С: автоматический обмен товарами, ценами, остатками, заказами. Реальные кейсы с ROI 300-380%. От 50 000 ₽.",
