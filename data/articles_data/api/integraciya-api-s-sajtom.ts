...
export const articleIntegraciyaApiSSajtom: Article = {
    ...
    title: "Интеграция API с сайтом: пошаговое руководство с кейсами",
    metaDescription: "Интеграция API с сайтом от 15 000 ₽. Платёжные системы, CRM, маркетплейсы. Кейсы с ROI 380–680%. Бесплатная оценка за 24 часа →",
