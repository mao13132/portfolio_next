...
export const articleIntegraciyaApiSSajtom: Article = {
    ...
    title: "Интеграция 1с через API: разработка от 15 000 ₽, от 5 дней",
    metaDescription: "Интеграция 1с через API от 15 000 ₽. Интеграция с внешними сервисами, автоматизация обмена данными в реальном времени, от 5. Бесплатная оценка за 24 часа →",
