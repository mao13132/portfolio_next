...
export const articleAiBot: Article = {
    ...
    internalLinks: [
        ...
        { anchor: "интеграция ChatGPT для бизнеса", url: "/blog/chatgpt-dlya-biznesa", context: "Кейсы внедрения ChatGPT с ROI" },
        ...
        { anchor: "Telegram бот для салона красоты", url: "/blog/bot-dlya-salona-krasoty", context: "Запись, напоминания, лояльность — кейс салона" },
        { anchor: "Telegram бот для медицинской клиники", url: "/blog/bot-dlya-medkliniki", context: "Запись, карты пациентов, анализы" },
        { anchor: "Telegram бот для онлайн-школы", url: "/blog/bot-dlya-onlajn-shkoly", context: "Продажа курсов, доступы, оплата" },
        { anchor: "примеры автоматизации бизнеса", url: "/blog/primery-avtomatizacii-biznesa", context: "4 реальных кейса с ROI 300–520%" },
        { anchor: "автоматизация отдела продаж", url: "/blog/avtomatizaciya-otdela-prodazh", context: "CRM, боты, воронка — кейсы с цифрами" },
    ],
};
