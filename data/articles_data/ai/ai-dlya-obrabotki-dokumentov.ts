...
export const articleAiDlyaObrabotkiDokumentov: Article = {
    ...
    title: "AI для обработки документов: автоматизация с кейсами ROI 380-420% | DimaRazrab",
    metaDescription: "AI для обработки документов: OCR, классификация, извлечение данных. Кейсы ROI 380-420%. Внедрение от 60 000 ₽. Консультация →",
