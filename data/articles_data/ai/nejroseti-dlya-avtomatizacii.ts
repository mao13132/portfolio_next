...
export const articleNejrosetiDlyaAvtomatizacii: Article = {
    ...
    title: "Нейросети для автоматизации бизнес процессов: полное руководство —",
    metaDescription: "Нейросети для автоматизации бизнес процессов от 30 000 ₽. Внедрение ChatGPT и нейросетей, автоматизация контента и поддержки. Бесплатная оценка за 24 часа →",
