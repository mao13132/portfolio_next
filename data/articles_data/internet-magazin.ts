...
export const articleInternetMagazin: Article = {
    ...
    title: "Telegram бот для интернет-магазина: каталог, корзина, оплата",
    metaDescription: "Telegram бот для интернет-магазина от 50 000 ₽. Каталог, корзина, оплата, интеграция с 1С и складом. Бесплатная оценка за 24 часа →",
