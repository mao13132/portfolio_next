...
export const articleBotDlyaRieltora: Article = {
    ...
    metaDescription: "Telegram бот для риелтора от 45 000 ₽. Мониторинг 15+ площадок 24/7, CRM, ипотечный калькулятор, запись на показы. ROI 420%.. Бесплатная оценка за 24 часа →",
