...
export const articleBotDlyaStrahovki: Article = {
    ...
    metaDescription: "Telegram бот для страхового агента от 35 000 ₽. Калькулятор, онлайн-оформление, продление полисов.. Калькулятор полиса, онл. Бесплатная оценка за 24 часа →",
