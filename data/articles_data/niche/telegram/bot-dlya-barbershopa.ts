...
export const articleBotDlyaBarbershopa: Article = {
    ...
    metaDescription: "Telegram бот для барбершопа от 25 000 ₽. Запись 24/7, программа лояльности, напоминания, предоплата.. Запись, программа лоя. Бесплатная оценка за 24 часа →",
