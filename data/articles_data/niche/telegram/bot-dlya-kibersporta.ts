...
export const articleBotDlyaKibersporta: Article = {
    ...
    metaDescription: "Telegram бот для киберспортивной организации от 35 000 ₽. Геймификация, скины, турниры, таблица лидеров. ROI 350%.. Геймифи. Бесплатная оценка за 24 часа →",
