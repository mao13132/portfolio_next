...
export const articleBotDlyaMebeli: Article = {
    ...
    metaDescription: "Telegram бот для мебельной мастерской от 30 000 ₽. Портфолио, калькулятор, запись на замер.. Портфолио работ, калькулятор с. Бесплатная оценка за 24 часа →",
