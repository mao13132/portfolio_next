...
export const articleBotDlyaRepetitora: Article = {
    ...
    title: "Telegram бот для репетитора: запись учеников, ДЗ, оплата занятий",
    metaDescription: "Telegram бот для репетитора от 30 000 ₽. Запись учеников, домашние задания, предоплата, напоминания. ROI 400%.. Запись учен. Бесплатная оценка за 24 часа →",
