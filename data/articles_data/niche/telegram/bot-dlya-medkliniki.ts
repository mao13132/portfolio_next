...
export const articleBotDlyaMedkliniki: Article = {
    ...
    metaDescription: "Telegram бот для медицинской клиники от 40 000 ₽. Запись к врачу 24/7, напоминания, предоплата, результаты анализов.. Запис. Бесплатная оценка за 24 часа →",
