...
export const articleBotDlyaSvadby: Article = {
    ...
    metaDescription: "Telegram бот для свадебного агентства от 35 000 ₽. Портфолио, калькулятор, запись, предоплата.. Портфолио свадеб, калькулят. Бесплатная оценка за 24 часа →",
