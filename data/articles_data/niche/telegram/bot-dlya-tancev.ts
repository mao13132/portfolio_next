...
export const articleBotDlyaTancev: Article = {
    ...
    metaDescription: "Telegram бот для танцевальной школы от 25 000 ₽. Запись 24/7, абонементы, расписание, лояльность.. Запись, абонементы, расп. Бесплатная оценка за 24 часа →",
