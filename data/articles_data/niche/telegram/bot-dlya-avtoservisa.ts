...
export const articleBotDlyaAvtoservisa: Article = {
    ...
    title: "Telegram бот для автосервиса: запись, отслеживание, уведомления",
    metaDescription: "Telegram бот для автосервиса от 30 000 ₽. Запись 24/7, отслеживание ремонта, уведомления. Бесплатная оценка →",
