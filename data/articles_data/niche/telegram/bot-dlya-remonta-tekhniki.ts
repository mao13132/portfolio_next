...
export const articleBotDlyaRemontaTekhniki: Article = {
    ...
    metaDescription: "Telegram бот для сервиса ремонта от 25 000 ₽. Заказ, отслеживание статуса, уведомления.. Заказ, отслеживание статуса, уведо. Бесплатная оценка за 24 часа →",
