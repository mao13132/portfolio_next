...
export const articleBotDlyaStomatologii: Article = {
    ...
    metaDescription: "Telegram бот для стоматологии от 40 000 ₽. Запись 24/7, карты пациентов, напоминания о повторных осмотрах. ROI 400%. Бесплатная оценка за 24 часа →",
