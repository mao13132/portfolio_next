...
export const articleBotDlyaKoucha: Article = {
    ...
    metaDescription: "Telegram бот для коуча от 30 000 ₽. Запись на сессии, домашние задания, трекер прогресса, абонементы. ROI 600%.. Запись на . Бесплатная оценка за 24 часа →",
