...
export const articleBotDlyaFotografa: Article = {
    ...
    metaDescription: "Telegram бот для фотографа от 30 000 ₽. Портфолио, запись 24/7, калькулятор, предоплата, напоминания. ROI 500%.. Портфолио,. Бесплатная оценка за 24 часа →",
