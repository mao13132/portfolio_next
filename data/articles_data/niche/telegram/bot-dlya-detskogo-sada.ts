...
export const articleBotDlyaDetskogoSada: Article = {
    ...
    metaDescription: "Telegram бот для детского сада от 30 000 ₽. Ежедневные отчёты, оплата, объявления, запись.. Ежедневные отчёты родителям, оп. Бесплатная оценка за 24 часа →",
