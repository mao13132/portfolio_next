...
export const articleBotDlyaAtele: Article = {
    ...
    title: "Telegram бот для ателье: заказ, уведомления, программа лояльности",
    metaDescription: "Telegram бот для ателье от 25 000 ₽. Онлайн-заказ 24/7, уведомления о готовности, программа лояльности.. Онлайн-заказ, увед. Бесплатная оценка за 24 часа →",
