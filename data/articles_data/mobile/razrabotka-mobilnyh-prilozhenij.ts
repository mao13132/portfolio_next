...
export const articleRazrabotkaMobilnihPrilozhenij: Article = {
    ...
    title: "Разработка приложений для мобильных устройств: цена от 50 000 ₽, от",
    metaDescription: "Разработка приложений для мобильных устройств от 50 000 ₽. iOS и Android, кроссплатформенная разработка на Flutter и React. Бесплатная оценка за 24 часа →",
