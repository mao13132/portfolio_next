...
export const articleTelegramBotDlyaWildberries: Article = {
    ...
    title: "Telegram бот для Wildberries: мониторинг, аналитика, управление | DimaRazrab",
    metaDescription: "Telegram бот для Wildberries: мониторинг цен, уведомления о заказах, аналитика продаж. Автоматизация работы с WB через бота. Примеры →",
