...
export const analitikaMarketplejsovPart1: ArticleSection[] = [
    {
        ...
        content: `По данным Wordstat, запрос «аналитика маркетплейсов» набирает около 350 показов в месяц, «аналитика wildberries» — ещё 500+. Селлеры всё больше осознают, что без данных невозможно принимать правильные решения.
