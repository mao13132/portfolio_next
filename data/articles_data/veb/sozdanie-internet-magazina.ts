...
export const articleSozdanieInternetMagazina: Article = {
    ...
    title: "Сайт интернет магазин на заказ: цена от 50 000 ₽, от 14 дней",
    metaDescription: "Создание сайт интернет магазин на заказ от 50 000 ₽. Каталог товаров, корзина, оплата, интеграция с 1С и складом, от 14 дней. Бесплатная оценка за 24 часа →",
