...
export const articleRazrabotkaSajtaPodKlyuchVeb: Article = {
    ...
    title: "Разработка сайта под ключ: что входит, стоимость, сроки | DimaRazrab",
    metaDescription: "Разработка сайта под ключ: от дизайна до запуска. Стоимость от 50 000 ₽. Next.js, Python, FastAPI. Реальные кейсы. Бесплатная оценка →",
