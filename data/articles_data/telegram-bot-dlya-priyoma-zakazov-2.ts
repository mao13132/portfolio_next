...
export const articleTelegramBotDlyaPriyomaZakazov2: Article = {
    ...
    title: "Telegram бот для заказов: доставка, еда, товары — кейсы",
    metaDescription: "Telegram бот для заказов: доставка, еда, товары от 30 000 ₽. Каталог, корзина, оплата, уведомления. Реальные кейсы. Бесплатная оценка за 24 часа →",
