...
export const articleKakVnedritChatgptVBiznes: Article = {
    ...
    title: "Как внедрить ChatGPT в бизнес: 7 способов и 3 кейса",
    metaDescription: "Как внедрить ChatGPT в бизнес от 20 000 ₽. 7 способов применения, 3 кейса с ROI 400%. Бесплатная оценка за 24 часа →",
