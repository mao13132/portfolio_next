...
export const articlePrimeryAvtomatizacii: Article = {
    ...
    title: "Информационные системы автоматизации бизнес процессов: полное",
    metaDescription: "Информационные системы автоматизации бизнес процессов от 7 000 ₽. Автоматизация продаж и поддержки клиентов, приём заказов. Бесплатная оценка за 24 часа →",
