...
export const articleRazrabotkaCrmErp: Article = {
    ...
    title: "Разработка CRM и ERP систем: отличия, стоимость, примеры | DimaRazrab",
    metaDescription: "Разработка CRM и ERP на заказ от 80 000 ₽. Отличия CRM от ERP, этапы внедрения, кейсы с ROI 300%. Бесплатная оценка за 24 часа →",
