...
export const articleRazrabotkaCrmErp: Article = {
    ...
    title: "Разработка CRM и ERP: отличия, стоимость от 80 000 ₽",
    metaDescription: "Разработка CRM и ERP от 80 000 ₽. Отличия, этапы внедрения, интеграция с 1С и Telegram. Кейсы с ROI 300–580%. Бесплатная оценка за 24 часа →",
