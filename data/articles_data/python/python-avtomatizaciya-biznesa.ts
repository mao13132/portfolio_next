...
export const articlePythonAvtomatizaciyaBiznesa: Article = {
    ...
    title: "Python для автоматизации бизнеса: скрипты с ROI 280–520%",
    metaDescription: "Python для автоматизации бизнеса от 30 000 ₽. Парсинг, интеграции, скрипты. Экономия 6–16 часов/день. Бесплатная оценка за 24 часа →",
