...
export const pythonParsingNaZakazPart1: ArticleSection[] = [
    {
        ...
        content: `Запрос «парсинг на заказ» набирает сотни показов в месяц, «python парсинг данных» — ещё больше. Парсинг стал одним из самых востребованных направлений Python-разработки, потому что данные — это новая нефть.
