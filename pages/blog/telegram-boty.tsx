                ...
                <section className={styles.hero}>
                    ...
                    <div className={styles.container}>
                        ...
                        >
                            ...
                            до интернет-магазина и AI-помощников. 10 подробных руководств с примерами,
                    ...
                    <div className={styles.container}>
                        ...
                        >
                            ...
                            <div style={{ fontSize: '16px', color: 'var(--lp-text-muted)', lineHeight: 1.8 }}>
                                ...
                                <p>
                                    Ниже — 10 подробных руководств, которые помогут разобраться в теме: от выбора технологии до расчёта
                                    стоимости и внедрения AI. Каждая статья — это 3500-4500 слов практической информации с примерами,
