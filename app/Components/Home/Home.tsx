    ...
    return (
        <section {...props} className={cn(styles['home'], className)} id="home">
            ...
            >
                ...
                >Я профессиональный разработчик с опытом создания высокоэффективных и удобных решений, которые экономят ваше время и деньги. Погружаюсь в задачи бизнеса и создаю инструменты, которые приносят результат</motion.p>
