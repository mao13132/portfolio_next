...
- Sitemap — **✅ на бекенде (FastAPI)**, на фронтенде НЕ НУЖНО
- robots.txt — **✅ на бекенде (FastAPI)**, на фронтенде НЕ НУЖНО
- Яндекс.Вебмастер — не настроен (предположительно)
- Яндекс.Метрика — не настроен (предположительно)

### Что критически отсутствует
1. ~~robots.txt~~ — ✅ на бекенде (FastAPI), НЕ НУЖНО на фронтенде
2. ~~Динамический sitemap.xml~~ — ✅ на бекенде (FastAPI), НЕ НУЖНО на фронтенде
...
- Техническая оптимизация (sitemap и robots.txt — на бекенде, мета-теги, скорость)
